...
class IsFavoriteUseCase(private val repository: ArtworkRepository) {
    suspend operator fun invoke(artworkId: Int): Result<Boolean> = repository.isFavorite(artworkId)
}